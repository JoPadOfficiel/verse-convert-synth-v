...
fn make_track(
    ...
    for (index, source_note) in notes.iter().enumerate() {
        ...
        let attached = selected_attached_lyric(source_note, projection.lanes);
...
fn projected_lyric_count(
    ...
    notes
        ...
        .filter(|(index, note)| {
            ...
            selected_attached_lyric(note, lanes)
